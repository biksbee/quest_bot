...
class Bot(ContextInstanceMixin["Bot"]):
    ...
    async def edit_message_reply_markup(
        ...
        """
        Use this method to edit only the reply keyboards of messages. On success, if the edited message is not an inline message, the edited :class:`aiogram.types.message.Message` is returned, otherwise :code:`True` is returned.
