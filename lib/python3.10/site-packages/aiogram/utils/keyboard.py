...
class KeyboardBuilder(Generic[ButtonType]):
    """
    Generic keyboard builder that helps to adjust your keyboards with defined shape of lines.
    ...
    def _validate_markup(self, markup: List[List[ButtonType]]) -> bool:
        """
        Check that passed keyboards has correct data structure
    ...
    def copy(self: "KeyboardBuilder[ButtonType]") -> "KeyboardBuilder[ButtonType]":
        """
        Make full copy of current builder with keyboards
    ...
    def export(self) -> List[List[ButtonType]]:
        """
        Export configured keyboards as list of lists of buttons

        .. code-block:: python

            >>> builder = KeyboardBuilder(button_type=InlineKeyboardButton)
            >>> ... # Add buttons to builder
            >>> keyboards = InlineKeyboardMarkup(inline_keyboard=builder.export())
    ...
    def add(self, *buttons: ButtonType) -> "KeyboardBuilder[ButtonType]":
        """
        Add one or many buttons to keyboards.
    ...
    def adjust(self, *sizes: int, repeat: bool = False) -> "KeyboardBuilder[ButtonType]":
        ...
        one size will be used for tail of the keyboards.
